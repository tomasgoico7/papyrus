...
export function EmptyState() {
  const { t } = useI18n();
  return (
    <div className="grid min-h-[28rem] place-items-center rounded-3xl border border-line bg-surface/60 px-6 text-center">
...
export function AnalyzingState() {
  const { t } = useI18n();
  return (
    <div className="grid min-h-[28rem] place-items-center rounded-3xl border border-line bg-surface px-6 text-center shadow-subtle">
...
export function ErrorState({ message }: { message: string }) {
  const { t } = useI18n();
  return (
    <div className="grid min-h-[28rem] place-items-center rounded-3xl border border-warning/30 bg-warning/5 px-6 text-center">
      <div className="max-w-xs">
